...
mock.onGet('/api/contacts/1').reply(() => {
  const contact = {
    id: '5e86805e2bafd54f66cc95c3',
...
mock.onGet('/api/contacts/1/emails').reply(() => {
  const emails = [
    {
      ...
      createdAt: moment()
        ...
        .toDate()
        .getTime(),
      description: 'Demand confirmation'
    },
    {
...
mock.onGet('/api/contacts/1/invoices').reply(() => {
  const invoices = [
    {
...
mock.onGet('/api/contacts/1/logs').reply(() => {
  const logs = [
    {
